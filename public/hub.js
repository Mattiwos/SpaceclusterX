class hub{
    ...
    draw(){
        ...
        fill(50);
        ellipse(this.x+width/2,this.y+height/2,this.citysize*8/9,this.citysize*8/9);
        ...
        for(let k=0;k<this.glow;k++){
            ...
            this.y+height/2,this.citysize+2+4*k,this.citysize+2+4*k);
        }
        ...
        for(var p=0;p<this.rectnumber-1;p++){
            ...
            ellipse (this.rectx[p]+width/2,this.recty[p]+height/2,this.rects,this.rects);
        }
